...
class Misc(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if 'good bot' in msg:
            ...
            await message.reply('Before you start bugging people for answers, have you checked out the \
                #league-rules and #league-announcements channels for what your answer? \
                If your answer cannot be found there, try typing `$help` to see if can help you find what you need.')
    ...
    async def poll(self, ctx, *, content:str):
        ...
        if ctx.channel.id == 1009118603322335272:
            ...
            ctx.send(content="You are only allowed to create polls in the #polls channel.")
